...
import { StoreWriter } from "./helpers.js";
import { extractFragmentContext } from "../../apollo-client-sm/src/cache/inmemory/helpers.js";
import type { KeyFieldsFunction } from "../../apollo-client-sm/src/cache/inmemory/policies.js";
...
describe("writing to the store", () => {
  ...
  describe("StoreWriter", () => {
    const writer = new StoreWriter(new InMemoryCacheRs());
