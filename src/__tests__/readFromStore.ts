...
import { StoreReader } from "./helpers.js";
import { defaultCacheSizes } from "../../apollo-client-sm/src/utilities/caching/sizes.js";
          ...
          Query: {
            fields: {
              books: {
                ...
                // the InMemoryCacheRs will ensure the actual key begins
                // with "books".
                keyArgs: () => "abc",
              },
            },
