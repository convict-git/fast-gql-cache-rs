...
import { makeVar, MissingFieldError } from "@apollo/client/cache";
import { MockLink } from "@apollo/client/testing";
import { relayStylePagination } from "@apollo/client/utilities";
import { stringifyForDisplay } from "@apollo/client/utilities/internal";
import type { FieldPolicy, ReactiveVar } from "@apollo/client/cache";
import type { StorageType } from "../../apollo-client-sm/src/cache/inmemory/policies.js";
import { ObservableStream } from "../../apollo-client-sm/src/testing/internal/ObservableStream.js";
import { spyOnConsole } from "../../apollo-client-sm/src/testing/internal/disposables/spyOnConsole.js";
...
describe("type policies", function () {
  ...
  function checkAuthorName(cache: InMemoryCacheRs) {
    expect(
      cache.readQuery({
        query: gql`
          query {
  ...
  describe("field policies", function () {
    ...
    function testForceMerges(cache: InMemoryCacheRs) {
    ...
    it("can force merging references with non-normalized objects", async function () {
      ...
      async function check(cache: InMemoryCacheRs) {
