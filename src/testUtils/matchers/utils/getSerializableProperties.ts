// Copied from apollo-client-sm/src/testing/matchers/utils/getSerializableProperties.ts
// (the matchers here must stay under src/, which tsconfig.json roots at).
